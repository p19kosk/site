...
Η παραπάνω άσκηση προγραμματισμού πραγματοποιήθηκε με τη χρήση του site codepen.io.Πιο συγκεκριμένα,πρόσθεσα έναν  συνδυασμό φίλτρων.Με αυτόν τον τρόπο,σέρνοντας το ποντίκι πάνω στην εικόνα θα σας δείξει την φωτογραφία εικονικά τροποποιημένη.Τον κώδικα θα τον βρείτε κάνοντας κλικ [εδώ]( https://codepen.io/2019211/pen/zYBjmzy).
